...
var fnPreprocessTest = function(){
    ...
    console.log("전처리 테스트 진행 2");
		
		if( data != null )	preprocessRequestTest.push(data);
	});
	

  console.log("preprocessRequestTest : " + preprocessRequestTest);
	...
	if( preprocessRequestTest.length > 0 ){
	  ...
	  console.log("projectSequencePk :" + projectSequencePk);
    console.log("selectedOriginalDataPk :" + selectedOriginalDataPk);
