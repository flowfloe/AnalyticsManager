...
$(function(){
	...
	$(document).on("click", "#serverList li", function(){
		...
		console.log("choosed==>"+choosed.hasClass("activeSel"));
...
var createTable = function(){
	  ...
	  $("#logTable").DataTable( {
		...
		//테이블 상단 버튼 영역
		var addBtn	= "<button class='button material-icons play_arrow' onclick='fnStartInstance(\"샌드박스\")'></button>";
		addBtn		+= "<button class='button material-icons stop' onclick='fnStopInstance(\"샌드박스\")'></button>";
		addBtn		+= "<button class='button material-icons delete' onclick='fnDeleteInstance(\"샌드박스\")'></button>";
...
var fnChangeState = function(){
	...
	for( var i in instances ){
		...
		console.log("data==>" + data.SERVER_STATE);
